    ...
    class MapScreen
    {
        ...
        public static void draw(SpriteBatch spriteBatch, GameTime gameTime)
        {
            ...
            if (!paused)
            {
                ...
                {
                    if (fnotes[fi][0] < timer - (notew * 1.5) + (centerx / notespeed) - notew * 2 && fnotes[fi][1] < centerx + notew && fnotes[fi][2] == 0)
                    {
                ...
                {
                    if (gnotes[fi][0] < timer - (noteh * 1.5) + (centery / notespeed) - noteh && gnotes[fi][1] < centery + noteh && gnotes[fi][2] == 0)
                    {
                ...
                {
                    if (hnotes[fi][0] < timer - (notew * 1.5) + (centerx / notespeed) - notew * 2 && hnotes[fi][1] < centerx + notew && hnotes[fi][2] == 0)
                    {
                ...
                {
                    if (jnotes[fi][0] < timer - (noteh * 1.5) + (centery / notespeed) - noteh && jnotes[fi][1] < centery + noteh && jnotes[fi][2] == 0)
                    {
